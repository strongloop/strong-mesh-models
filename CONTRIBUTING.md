...
Thank you for your interest in `strong-mesh-models`, an open source project
administered by StrongLoop.

Contributing to `strong-mesh-models` is easy. In a few simple steps:
  ...
  * Sign the [Contributor License Agreement](https://cla.strongloop.com/agreements/strongloop/strong-mesh-models)
